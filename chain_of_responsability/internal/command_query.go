...
func (c *Creature2) String2() string {
...
func RunCommandQuery() {
	game := &Game{sync.Map{}}
	goblin := NewCreature2(game, "Goblin", 2, 2)
	fmt.Println(goblin.String2())

	d := NewDoubleAttackModifier2(game, goblin)
	fmt.Println(goblin.String2())
	d.Close()
